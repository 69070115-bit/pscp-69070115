...
```text
โจทให้อ่านค่าจำนวนเต็ม1ตัว แล้วหาว่าตั้งแต่0ถึงทตัวไหนหารด้วย10ลงตัวบ้าง
Input:
โปรแกรมรับจำนวนเต็มหนึ่งค่า n
Output:
จำนวนเลขที่หารด้วย10ลงตัว
Constraints:
หาเฉพาะตัวที่หารด้วย10ลงตัว
```
...
```text
อ่านจำนวนเต็ม
ใช้ลูปเพื่อวนค่าจนถึงจำนวนเต็มn
หารด้วย10แล้วเศษเป็น0
```
...
```text
หารแบบเอาเศษด้วย10 เพื่อหาตัวที่10หารลงตัว
```
