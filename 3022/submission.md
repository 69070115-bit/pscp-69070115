...
```text
ให้อินพุต3ค่าคืออุณหภูมิ หน่วยและหน่วยที่ต้องการแปลงเอ้าพุตคือค่าที่ถูกแปลงแล้ว โจทให้รับค่าของหน่วยนึงแล้วเปลี่ยนเป็นค่าของอีกหน่วยนึง
```
...
```text
อ่านค่าสตริงวาเป็นหน่วยอะไรแล้วให้แปลงเป็นอะไรโดยการแปลงคำนวณจากสูตร
```
