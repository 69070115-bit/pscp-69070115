...
```text
โจทให้แสดงฤดูกาลต่างๆโดยในเดือนที่3หารลงตัวตั้งแต่วันที่21ของเดือนนั้นจะเป็นฤดูต่อไปเลย
อินพุตคือวันกับเดือนรับค่าเป็นตัวเลข outputgเป็นฤดูแสดงค่าสตริง
```
...
```text
สร้างอินพุตจากนั้นใช้คำสั่งifเช่นถ้าอยู่ในเดือน1ให้แสดงผลว่าwinterแต่ถ้าอยู่ในเดือน3แล้วเป็นวันที่21หรือมากกว่าแสดงspring
```
...
```text
เหมือนแผนแรกเพราะ รันโค้ดไม่มีerrorและคำตอบถูกต้อง
```
...
if month in (1,2) :
    print("winter")
แสดงผลว่าเป็นwinterถ้าอยู่ในเดือน1,2
```
...
```text
    ...
    if day >= 21 :
        ...
        print("winter")
ตรวจสอบว่าในเดือนที่3 อินพุตเป็นวันที่21หรือมากกว่ารึป่าวถ้าเป็นอย่างนั้นจะแสดงว่าspring
```
