...
```text
โจทย์ต้องการให้หาว่าบ้านของผู้คนจะจมในวินาทีเท่าไหร่
input
รับค่าพื้นที่หมึกที่เพิ่มขึ้นทุกวินาทีและจำนวนบ้านที่ต้องการคำนวณ
แล้วรับพิกัดบ้านแต่ละหลัง ให้xคือแนวนอน y คือแนวตั้ง
output
แสดงเวลาที่บ้านแต่ละหลังจม
ถ้าเวลาที่คำนวณได้มีทศนิยมต้องปัดขึ้น เช่น 1.35 ปัดเป็น2
```
...
```text
รับค่าinkและจำนวนบ้าน
รับพิกัดบ้านแต่ละหลัง
คำนวณระยะจากบ้านถึงจุด(0,0)
คำนวณพื้นที่วงกลมด้วยสูตร pir**2
นำพื้นที่ที่ได้ไปหารด้วย ink เพื่อหาเวลาที่หมึกจะไปถึงบ้าน
ถ้าคำตอบเป็นทศนิยม ให้ปัดขึ้น
แสดงเวลาที่บ้านถูกท่วม
ทำซ้ำจนครบทุกบ้าน
```
...
```text
เหมือนแผนแรก เพราะตรวจสอบแล้วว่าถูกต้อง
```
...
```text
จะตรวจสอบถ้าxและyเป็น0 โปรแกรมสามารถตอบ0ได้
```
...
```text
ทดสอบถ้าคำตอบเป็นจำนวนเต็มโปรแกรมจะไม่ปัดขึ้น
```
